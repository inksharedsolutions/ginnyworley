            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Ginny Worley loves to hear from readers. You can reach him via email. 
                    ...
                    <nav className="social-media-nav">
                        <ul>
                            ...
                            <li>
                                <a href="https://www.facebook.com/Ginny-Worley-101892198106735/"
                                target="_blank"
                                rel="noreferrer">
                                    <FontAwesomeIcon   
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/52241580-poems-from-the-edge"
                                    rel="noreferrer"
                                    >
